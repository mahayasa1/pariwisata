...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $target_dir = "../../../asset/img/destinasi/";
    $path = $target_dir . basename($gambar);

    if(move_uploaded_file($tmp, $path)){
    $query = "INSERT INTO tempat_wisata (nama_tempat, alamat, deskripsi, gambar, harga_tiket, jam_buka, jam_tutup, fasilitas) 
                VALUES ('$nama_tempat', '$alamat', '$deskripsi' , '$gambar', '$harga_tiket', '$jam_buka', '$jam_tutup','$fasilitas')";
...
<body class="bg-dark">
    <div class="container d-flex justify-content-center align-items-center min-vh-100 mt-4">
        <div class="card p-4 bg-secondary text-light shadow-sm" style="max-width: 500px; width: 100%;">
            <h2 class="text-center mb-4">Add New Destinasi</h2>
            <form method="POST" action="" enctype="multipart/form-data">
                ...
                <button type="submit" class="btn btn-primary w-100">Add Destinasi</button>
            </form>
        </div>
    </div>
