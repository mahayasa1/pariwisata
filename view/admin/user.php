...
<div class="table-wrapper">
    ...
    <a href="../../controller/crud_admin/user/add.php" class="btn btn-primary mb-3">Tambah User</a>
    <table class="table table-bordered table-striped text-center">
        ...
        while ($row = $query->fetch_assoc()): ?>
            <tr>
                ...
                <td><?=$row['level']?></td>
                <td>
                    <a href='../../controller/crud_admin/user/update.php?id=<?=$row['id_user']?>' class='btn btn-warning btn-sm mb-2'>Edit</a> <br>
                    <a href='../../controller/crud_admin/user/delete.php?id=<?=$row['id_user']?>' class='btn btn-danger btn-sm' onclick="return confirm('Are you sure you want to delete this user?')">Delete</a>
                </td>
                </tr>
        <?php endwhile; ?>
        </tbody>
